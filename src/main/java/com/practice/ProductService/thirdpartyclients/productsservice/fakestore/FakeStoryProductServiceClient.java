package com.practice.ProductService.thirdpartyclients.productsservice.fakestore;
...
public class FakeStoryProductServiceClient {
    ...
    public FakeStoryProductServiceClient(RestTemplateBuilder restTemplateBuilder,   @Value("${fakestore.api.url}") String fakeStoreApiUrl,   @Value("${fakestore.api.paths.product}") String fakeStoreProductsApiPath) {
